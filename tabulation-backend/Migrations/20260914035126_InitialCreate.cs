        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Factions_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Games_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Scores_Factions_FactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Factions_DepartmentId",
                table: "Factions",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Games_DepartmentId",
                table: "Games",
                column: "DepartmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Scores_EventId_FactionId",
                table: "Scores",
                columns: new[] { "EventId", "FactionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Scores_FactionId",
                table: "Scores",
                column: "FactionId");
